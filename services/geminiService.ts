...
export const generateQuestionWithAI = async (
    ...
    if (subject === 'paragraph' && paragraphSkill) {
        // FIX: Corrected a typo in the newline character representation.
    ...
    if (questionType === 'quiz') {
        if (shouldGenerateImage) {
            ...
            imageInstruction = 'KESİNLİKLE bir "visualPrompt" alanı oluşturma veya herhangi bir görsel tarif etme. Soru tamamen metin tabanlı olmalıdır ve JSON çıktısında "visualPrompt" alanı bulunmamalıdır.';
        }
    }
