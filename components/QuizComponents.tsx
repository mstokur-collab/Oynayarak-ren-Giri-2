...
const GameScreen: React.FC<GameScreenProps> = ({ groupNames }) => {
    const { 
        ...
        handleQuestionAnswered: onQuestionAnswered, 
    ...
    const finishGame = useCallback(() => {
        window.speechSynthesis.cancel();
        // Mark the current question as solved if it has been answered
        ...
        navigate('/sonuc');
    }, [quizMode, streak, score, groupScores, isGroupMode, onGameEnd, answers, currentQuestion, currentQuestionIndex, onQuestionAnswered, navigate]);
    ...
    }, [currentQuestionIndex, totalQuestions, finishGame, quizMode, currentQuestion, answers, onQuestionAnswered]);
    ...
    }, [answers, currentQuestionIndex, quizMode, isGroupMode, activeGroup, playSound, finishGame, optionsToShow, goToNextQuestion]);
